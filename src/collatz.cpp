...
CollatzRunner::CollatzResult CollatzRunner::collatz( unsigned long num )
{
    CollatzResult ret{ };
 ...
 */
CollatzRunner::CollatzResult CollatzRunner::maxCollatz( unsigned long previous, unsigned long start, unsigned long end )
{
    ...
    for ( unsigned long i = start; i <= end; i++ )
    {
        ...
        if ( i == milestone )
        {
            ...
            // elapsed for i - start CollatzRunner calculations
